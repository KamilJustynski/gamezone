...
const Root = () => {
  return (
    <>
      ...
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-r  sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar"
      >
          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="ms-3">Lista gier</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Kategorie</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Ulubione</span>
              </NavLink>
            </li>
          </ul>
        </div>
      ...
      <div className="p-4 bg-gray-300 h-svh sm:ml-64">
